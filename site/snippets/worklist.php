<ul class="worklist">
	<li>
		<a href="<?php echo($site->url())?>/work/opengov"><img src="<?php echo( $site->url())?>/content/work/opengov/madison-snippet.png" /></a>
	...
	<li>
		<a href="<?php echo($site->url())?>/work/readi"><img src="<?php echo( $site->url())?>/assets/images/READi-snippet.png" /></a>
